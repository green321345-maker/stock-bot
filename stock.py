...
if selected:
    ...
    with tab5:
        ...
        webhook_provider = st.selectbox("웹훅 채널", ["discord", "generic"], format_func=lambda x: "Discord" if x == "discord" else "Generic(JSON)")
        webhook_url = st.text_input("Webhook URL (Discord/Slack/Telegram/IFTTT)", key="webhook")
